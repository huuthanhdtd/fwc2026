Xây dựng một webapp đơn giản, tương tác với google script để quản lý đặt cược tỉ số dùng cho nội bộ team chơi để tăng tính tương tác các trận đấu trong fifa world cup 2026 với các chức năng sau:
...
- mỗi trận đấu cược mặc định là 90', nếu có hiệp phụ hoặc penalty thì tạo 1 trận cược mới.
- bấm vào trận đấu, nhập tỉ số (1 ô textbox) đặt cược thứ tự đội chủ nhà - đội khách, ví dụ: 2-1 (home-away), bấm OK hoặc enter sẽ gọi google script để lưu vào google sheet

- hiển thị lịch sử đặt cược của người dùng trên một tab riêng, có thể lọc theo trận đấu hoặc ngày đặt cược.

- yêu cầu đăng nhập bằng google email

- giao diện thân thiện và dễ sử dụng

- hiển thị lịch sử đặt cược từng trận trực quan ngay trên card từng trận
